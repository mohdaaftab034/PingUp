...
// Inngest funtions to save user data to a database 
const syncUserCreation = inngest.createFunction(
    ...
    async ({ event }) => {
        ...
        // Check availibility for username 
...
//Inngest funtion to delete user from the data base
...
const sendNewConnectionRequestReminder = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('send-connection-request-mail', async () => {
            ...
            const body = `
            <div style="font-family: AbortSignal, sans-serif; padding: 20px;">
    ...
    async ({step})=> {
        ...
        for (const userId in unseenCount) {
            ...
            <div style="font-family: Arial, sans-serif; padding: 20px;">
                ...
                <p>You have ${unseenCount[userId]} unssen messages</p>
