            ...
            <form className='space-y-4' onSubmit={handleSaveProfile}>
              ...
              <div>
                <label htmlFor="" className='block text-sm font-medium text-gray-700 mb-1'>
                  ...
                  <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your username' onChange={(e)=> setEditForm({...editForm, location: e.target.value})} value={editForm.location} />
              </div>
