      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='flex flex-wrap gap-6 mt-6'>
          {dataArray.find((item)=> item.label === currentTab).value.map((user)=> (
            <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 cursor-pointer bg-white shadow rounded-md'>
              <img onClick={()=> navigate(`/profile/${user._id}`)} src={user.profile_picture} className='rounded-full w-12 h-12 shadow-md mx-auto' alt="" />
